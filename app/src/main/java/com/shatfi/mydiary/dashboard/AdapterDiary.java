...
import com.shatfi.mydiary.databinding.EditDiaryBinding;
...
public class AdapterDiary extends RecyclerView.Adapter<AdapterDiary.AdapterHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterDiary.AdapterHolder holder, @SuppressLint("RecyclerView") int position) {
        ModelDiary modelDiary = arrayList.get(position);
        String title = modelDiary.getTittle();
    ...
    private void editDiary(ModelDiary md, EditDiaryBinding editBinding){
        ...
        editBinding.title.setText(md.getTittle());
